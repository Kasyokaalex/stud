        ...
        <div class="widget-content nopadding">
          <form action="signup.php" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  class="span11" value="<?php echo$pfname?>" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" value="<?php echo$padm?>" class="span11" name="adm" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Age :</label>
              <div class="controls">
                <input type="number" class="span11" name="age" value="<?php echo$page?>" />
              </div>
            </div>
...
if(isset($_POST['submit'])){
    $upname=$_POST['fname'];
    $upclass=$_POST['class'];
    $update=mysqli_query($conn,"update student set fname='$upfname',class='$upclass' where id='$id' ")or
